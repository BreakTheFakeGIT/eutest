...
# ---------- Logging Setup ----------
logger = logger_utils.setup_logger(name="eu_llm_asyncio_multi")
...
QA_PROMPT = ChatPromptTemplate.from_messages([
    ...
    ("user",
     "Fragment tekstu:\n{context}\n\n"
     "Pytanie:\n{question}\n\n"
     "Podaj odpowiedz krótko i zwieźle. Nie proponuj. Jeśli nie znasz odpowiedzi, napisz : 'brak informacji'"
    ),
])
