...
# ---------- MAIN----------
questions_main = [
    "W punktach, wymień 10 słów kluczowych związanych z podatkiem?",
    "W punktach, wymień artykuły, przepisy prawne wksazane w tekście?",
    "W 3 punktach, podsumuj fragment tekstu stanu faktycznego.",
    "W 1 punkcie, wskaż, czy wnioskodawca jest osobą fizyczną, jednostką samorządu terytorialnego (gmina, powiat, województwo), formą spółki (np.: sp zoo, sp jawna, sp komandytowa, cywilna), czy innym podmiotem (np. stowarzyszenie, spółdzielnia, leśnictwo itp.)?",
    "W 1 punkcie, wskaż, czy wnioskodawca korzysta z ulg podatkowych lub prawo do odliczenia podatku lub zwolnień podatkowych (wymień jakie)?",
...
"W 3 punktach, wskaż,  wniosek dotyczy sprzedaży towaru, świadczenia usług?",
...
"W 1 punkcie, wskaż, jakie i skąd pochodzi źródło przychodu wnioskodawcy (np.: z pracy, emerytury, renty, działalności wykonywanej osobiście, pozarolniczej działalności gospodarczej, działalności rolniczej lub działów specjalnych, najmu, kapitałów pieniężnych, zbycia nieruchomości/ruchomości, z zagranicy)?",
...
questions_cit = questions_main + [
    ...
    "W 1 punkcie, wskaż, czy wnioskodawca, podlega obowiązkowi podatkowemu od całości swoich dochodów bez względu na miejsce ich osiągania?",
...
"Czy wniosek dotyczy walut obcych, złota dewizowego/złota inwestycyjnego?",
